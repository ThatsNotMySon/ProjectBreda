...
public class DataParser {
    ...
    /** Receives a JSONObject and returns:
     * - the bounds of the route (northeast/soutwest in th first list of LatLng
     * - a list of lists containing latitude and longitude for the route legs*/
